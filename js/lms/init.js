...
function setComplete(){
	...
	if(lmsConnected && stopTwo==1){
		...
		var scormPass=parseInt(localStorage.getItem('passScore'))
		console.log("scormScore est égal à ..-.."+scormScore)
		scorm.set("cmi.core.score.raw", scormScore); 
		
		function began(){
		if(scormScore>scormPass){ console.log("READY TO RUMBLEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE");scorm.set("cmi.core.lesson_status","passed");
